import{d as ld,w as ni}from"./index.91905744.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd="storage";function _E(t,e,n){return t=$(t),z_(t,e,n)}function EE(t){return t=$(t),H_(t)}function IE(t,e){return t=$(t),Q_(t,e)}function X_(t=Fi(),e){t=$(t);const s=Zs(t,cd).getImmediate({identifier:e}),r=Mc("storage");return r&&J_(s,...r),s}function J_(t,e,n,s={}){Y_(t,e,n,s)}function Z_(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new na(n,s,r,e,bt)}function eE(){_t(new et(cd,Z_,"PUBLIC").setMultipleInstances(!0)),ke(Rc,Nc,""),ke(Rc,Nc,"esm2017")}eE();const tE={apiKey:"AIzaSyDBdOPNQpH5LCM1HlC0mtDAfNoQrW0isMg",authDomain:"linkyou-94b1e.firebaseapp.com",projectId:"linkyou-94b1e",storageBucket:"linkyou-94b1e.appspot.com",messagingSenderId:"744828920447",appId:"1:744828920447:web:5f7f5af2eeb877f5a3954a",measurementId:"G-8GKS24MR9L"};Bc(tE);const nE=Ny(),cn=qw(),TE=X_();function sE(){let t;if(!cn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=ni(null);return{subscribe:n}}const{subscribe:e}=ni((cn==null?void 0:cn.currentUser)??null,n=>(t=Ov(cn,s=>{n(s)}),()=>t()));return{subscribe:e}}const rE=sE();function iE(t){let e;const n=ky(nE,t),{subscribe:s}=ni(null,r=>(e=jy(n,i=>{r(i.data()??null)}),()=>e()));return{subscribe:s,ref:n,id:n.id}}const SE=ld(rE,(t,e)=>{if(t)return iE(`users/${t.uid}`).subscribe(e);e(null)});export{Ke as G,gE as Q,cE as R,yE as W,aE as _,SE as a,uE as b,nE as c,dE as d,pE as e,cn as f,ky as g,vE as h,TE as i,mE as j,lE as k,EE as l,fE as m,_E as n,hE as o,IE as r,wE as s,rE as u};
